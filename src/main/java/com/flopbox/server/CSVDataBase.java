...
public class CSVDataBase {
	 ...
	 */
	public final static String USER_FILE = "resources/user.csv";
	/**
	 * Le chemin vers le fichier CSV contenant les serveurs.
	 */
	public final static String SERVER_FILE = "resources/server.csv";
	/**
	 ...
	 * tables)
	 */
	public static final String[] SERVER_DB = { "id", "host", "port" };
